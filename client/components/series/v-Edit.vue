        ...
        <div class="w-full max-w-xs">
          ...
          >
            <label class="label cursor-pointer">
              ...
              <input
                @click="useSeries.series_edit.status = 'public'"
                type="radio"
                name="radio-10"
                class="radio checked:bg-red-500"
                :checked="useSeries.series_edit.status == 'public'"
              />
            </label>
          </div>
          <div
          ...
          >
            <label class="label cursor-pointer">
              ...
              <input
                :checked="useSeries.series_edit.status == 'private'"
                @click="useSeries.series_edit.status = 'private'"
                type="radio"
                name="radio-10"
