  ...
  <div>
    <footer class="footer p-10 text-base-content">
      <div>
        ...
        <a class="link link-hover"> Bài viết</a>
        <!-- <a class="link link-hover"> Chuỗi bài viết</a> -->
        <a class="link link-hover"> Câu hỏi</a>
        <!-- <a class="link link-hover"> Chủ đề</a> -->
      </div>
      <div>
        <span class="footer-title">Cộng đồng</span>
        <a class="link link-hover">Nhóm</a>
        <a class="link link-hover">Người dùng</a>
      </div>
      <div>
