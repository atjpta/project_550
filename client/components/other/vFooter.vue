  ...
  <div class="">
    ...
    <footer class="footer px-10 py-5 border-t text-base-content border-base-300">
      <div class="items-center grid-flow-col">
        <div
          @click="navigateTo('/')"
          class="btn btn-ghost bg-transparent hover:bg-transparent text-xl font-black"
        >
          <!-- logo -->
          <span
        ...
        <div>CTUF - Trang hỏi đáp chia sẻ <br />Design by B1910027</div>
      </div>
        ...
        <div class="grid grid-flow-col gap-4">
          ...
          <NuxtLink to=""
            ...
            >
              ...
              ></path></svg
          ></NuxtLink>
          <nuxtLink to="https://www.facebook.com/atjpta"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
