<template>
  <div>
    <div class="">
      <nuxtLink to="/auth/signin" v-if="!useAuth.isUserLoggedIn" class="btn btn-outline mb-1">
        đăng nhập
      </nuxtLink>
      <div v-if="useAuth.isUserLoggedIn" class="dropdown dropdown-end">
        ...
        <ul tabindex="0" class="border-2 p-2 shadow menu menu-compact dropdown-content bg-base-100 rounded-box w-52">
