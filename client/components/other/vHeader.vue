<template>
  <div class="glass ring-0">
    <div class="text-xl shadow-sm pt-1">
      <div class="flex justify-between">
        <div class="flex">
          ...
          <div
            @click="navigateTo('/')"
            class="btn btn-ghost bg-transparent hover:bg-transparent font-black text-white"
          >
            <!-- logo -->
            <span
          ...
          <div @mouseleave="focus = false" @mouseenter="focus = true">
            <div>
              <div class="input-group" v-if="route.path.slice(0, 7) != '/search'">
                ...
                <button @click="navigateTo('/search/course')" class="btn btn-square">
    ...
    <div
      @click="open = false"
      v-if="open"
      class="fixed h-screen w-screen sm:hidden"
    ></div>
  </div>
</template>
