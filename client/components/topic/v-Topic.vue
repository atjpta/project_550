    ...
    <transition name="bounce">
      <div class="rounded-2xl">
        <div class="glass rounded-2xl ring-0 p-2 my-2 lg:flex justify-between sticky top-14">
          <div class="w-fit">
            <nuxtLink class="hover:text-sky-500 hover:scale-110 duration-500" :to="`/user/${author?._id}/overview`">
              <!-- tác giả -->
              <div class="flex">
                <div class="avatar">
          ...
          <div class="flex mt-1">
            ...
            <!-- thông báo  -->
            <div v-if="useFollow.follow && useAuth.user" class="ml-1 tooltip" :data-tip="useFollow.follow.notification ? 'Tắt thông báo' : 'Bật thông báo'
              ">
