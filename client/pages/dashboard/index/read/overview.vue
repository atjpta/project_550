<template>
  <div class="mt-3 rounded-2xl">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
      ...
      <div @click="navigateTo(`/dashboard/read/post`)" class="stats shadow mb-2 mr-2 cursor-pointer">
        <div class="stat">
          <div class="stat-figure">
      ...
      <div @click="navigateTo(`/dashboard/read/series`)" class="stats shadow mb-2 mr-2 cursor-pointer">
        <div class="stat">
          <div class="stat-figure">
      ...
      <div @click="navigateTo(`/dashboard/read/question`)" class="stats shadow mb-2 mr-2 cursor-pointer">
        <div class="stat">
          <div class="stat-figure">
      ...
      <div @click="navigateTo(`/dashboard/read/topic`)" class="stats shadow mb-2 mr-2 cursor-pointer">
        <div class="stat">
          <div class="stat-figure">
